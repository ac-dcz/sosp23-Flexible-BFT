...
pub enum ConsensusError {
    ...
    #[error("Received more than one endorse vote from {0} siganl {1}")]
    AuthorityReuseinEndorse(PublicKey, u8),

    #[error("Received more than one promise vote from {0}")]
    AuthorityReuseinPromise(PublicKey),
